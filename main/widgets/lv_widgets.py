...
def slider_event_cb(slider, e):
    if e == lv.EVENT.VALUE_CHANGED:
        if slider.get_type() == lv.slider.TYPE.NORMAL:
            ...
            slider.set_style_local_value_str(
                lv.slider.PART.KNOB, lv.STATE.DEFAULT, str(slider_value))
        else:
            ...
            slider.set_style_local_value_str(
                lv.slider.PART.INDIC, lv.STATE.DEFAULT, slider_string)
...
def controls_create(parent):
    ...
    slider.set_style_local_margin_top(
        lv.slider.PART.BG, lv.STATE.DEFAULT, LV_DPX(25))
    slider.set_style_local_value_font(
        lv.slider.PART.KNOB, lv.STATE.DEFAULT, lv.theme_get_font_small())
    slider.set_style_local_value_ofs_y(
        lv.slider.PART.KNOB, lv.STATE.FOCUSED, - LV_DPX(25))
    slider.set_style_local_value_opa(
        lv.slider.PART.KNOB, lv.STATE.DEFAULT, lv.OPA.TRANSP)
    slider.set_style_local_value_opa(
        lv.slider.PART.KNOB, lv.STATE.FOCUSED, lv.OPA.COVER)
    slider.set_style_local_transition_time(
        lv.slider.PART.KNOB, lv.STATE.DEFAULT, 300)
    slider.set_style_local_transition_prop_5(
        lv.slider.PART.KNOB, lv.STATE.DEFAULT, lv.STYLE.VALUE_OFS_Y)
    slider.set_style_local_transition_prop_6(
        lv.slider.PART.KNOB, lv.STATE.DEFAULT, lv.STYLE.VALUE_OPA)
    ...
    slider.set_style_local_value_ofs_y(
        lv.slider.PART.INDIC, lv.STATE.DEFAULT, - LV_DPX(25))
    slider.set_style_local_value_font(
        lv.slider.PART.INDIC, lv.STATE.DEFAULT, lv.theme_get_font_small())
    slider.set_style_local_value_opa(
        lv.slider.PART.INDIC, lv.STATE.DEFAULT, lv.OPA.COVER)
    slider.set_event_cb(slider_event_cb)
    lv.event_send(slider, lv.EVENT.VALUE_CHANGED,
                  None)      # To refresh the text
    ...
    h.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "Text input")
    ...
    ta.set_cursor_hidden(True)
    #lv_obj_set_event_cb(ta, ta_event_cb);
    lv.cont.set_fit4(h, lv.FIT.PARENT, lv.FIT.PARENT,
...
def visuals_create(parent):
    ...
    if disp_size <= lv.DISP_SIZE.SMALL:
        chart.set_style_local_text_font(
            lv.chart.PART.SERIES_BG, lv.STATE.DEFAULT, lv.theme_get_font_small())

    chart.set_drag_parent(True)
    chart.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "Line chart")
    ...
    if disp_size > lv.DISP_SIZE.SMALL:
        chart.set_style_local_pad_left(
            lv.chart.PART.BG, lv.STATE.DEFAULT, 4 * (LV_DPI // 10))
        chart.set_style_local_pad_bottom(
            lv.chart.PART.BG, lv.STATE.DEFAULT, 3 * (LV_DPI // 10))
        chart.set_style_local_pad_right(
            lv.chart.PART.BG, lv.STATE.DEFAULT, 2 * (LV_DPI // 10))
        chart.set_style_local_pad_top(
            lv.chart.PART.BG, lv.STATE.DEFAULT, 2 * (LV_DPI // 10))
        chart.set_y_tick_length(0, 0)
        chart.set_x_tick_length(0, 0)
        chart.set_y_tick_texts("600\n500\n400\n300\n200",
                               0, lv.chart.AXIS.DRAW_LAST_TICK)
        chart.set_x_tick_texts(
    ...
    chart2.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "Column chart")
    ...
    lmeter.set_style_local_value_str(
        lv.linemeter.PART.MAIN, lv.STATE.DEFAULT, "Line meter")

    label = lv.label(lmeter, None)
    label.align(lmeter, lv.ALIGN.CENTER, 0, 0)
    label.set_style_local_text_font(
        lv.label.PART.MAIN, lv.STATE.DEFAULT, lv.theme_get_font_title())
    ...
    gauge.set_style_local_value_str(
        lv.gauge.PART.MAIN, lv.STATE.DEFAULT, "Gauge")
    ...
    bar.set_style_local_value_font(
        lv.bar.PART.BG, lv.STATE.DEFAULT, lv.theme_get_font_small())
    bar.set_style_local_value_align(
        lv.bar.PART.BG, lv.STATE.DEFAULT, lv.ALIGN.OUT_BOTTOM_MID)
    bar.set_style_local_value_ofs_y(
        lv.bar.PART.BG, lv.STATE.DEFAULT, LV_DPI // 20)
    bar.set_style_local_margin_bottom(
        lv.bar.PART.BG, lv.STATE.DEFAULT, LV_DPI // 7)
    ...
    led_h.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "LEDs")
    ...
    led.set_bright((LV_LED_BRIGHT_MAX - LV_LED_BRIGHT_MIN) //
                   2 + LV_LED_BRIGHT_MIN)
    ...
    if disp_size == lv.DISP_SIZE.MEDIUM:
        ...
        led_h.align(bar_h, lv.ALIGN.OUT_BOTTOM_MID, 0, lv.obj.get_style_margin_top(lv.obj.__cast__(
            led_h), lv.obj.PART.MAIN) + lv.obj.get_style_pad_inner(parent, lv.page.PART.SCROLLABLE))
...
def selectors_create(parent):
    ...
    if disp_size > lv.DISP_SIZE.MEDIUM:
        ...
        if disp_size <= lv.DISP_SIZE.SMALL:
            cal.set_style_local_text_font(
                lv.calendat.PART.BG, lv.STATE.DEFAULT, lv.theme_get_font_small())
    ...
    if disp_size <= lv.DISP_SIZE.SMALL:
        ...
        h.set_style_local_border_opa(
            lv.PART.MAIN, lv.STATE.DEFAULT, lv.OPA.TRANSP)
    ...
    roller.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "Roller")
    ...
    dd.set_style_local_value_str(
        lv.cont.PART.MAIN, lv.STATE.DEFAULT, "Dropdown")
    if disp_size <= lv.DISP_SIZE.SMALL:
...
display = scr.get_disp()
disp_size = display.get_size_category()
tv.set_style_local_pad_left(lv.tabview.PART.TAB_BG,
                            lv.STATE.DEFAULT, disp_drv.hor_res // 2)
...
sw.set_style_local_value_align(
    lv.switch.PART.BG, lv.STATE.DEFAULT, lv.ALIGN.OUT_RIGHT_MID)
